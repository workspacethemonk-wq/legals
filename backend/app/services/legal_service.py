...
"""
    ...
    def __init__(self):
        ...
        self.system_prompt = """You are 'Sahayak', a fast and expert Legal Aid Assistant for Indian citizens. Your goal is to empower users with actionable legal guidance, focusing on the new laws (BNS, BNSS, BSA).
...
- ALWAYS include a disclaimer: "I am an AI, not a lawyer. Use this as a guide and consult a qualified advocate for court matters." """
    ...
    def generate_legal_response(self, query, context):
        ...
        full_prompt = f"""You are 'Sahayak'. You MUST follow the structure below.
